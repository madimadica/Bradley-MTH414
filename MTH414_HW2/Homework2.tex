...
\fancyhead[LO]{MTH 414 - Homework \#2}
\fancyfoot[CO]{Page \thepage}

\noindent MTH 414 - Spring 2023
\\Assignment \#2
\\Due: Monday, January 30th 2023 (2:00PM)


\begin{enumerate}
\item \input{question_1.tex}\vspace{0.4in}
\item \input{question_2.tex}\vspace{0.4in}
\item \input{question_3.tex}\vspace{0.4in}
\item \input{question_4.tex}
\item \input{question_5.tex}\newpage
\item \input{question_6.tex}
\end{enumerate}
